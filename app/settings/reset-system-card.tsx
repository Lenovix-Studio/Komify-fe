      ...
      <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <p className="mt-1 max-w-2xl text-sm leading-relaxed text-muted-foreground">
              Deletes all comic metadata, chapters, bookmarks, reading history,
              and master tags from PostgreSQL, as well as all physical images
            ...
            <div className="mt-4 flex items-start gap-3 rounded-2xl border border-destructive/20 bg-destructive/10 p-4">
              ...
              <p className="text-xs sm:text-sm font-medium leading-normal text-destructive">
                This action is irreversible. All database records and physical
                comic assets will be permanently wiped.
              </p>
            </div>
          </div>
        </div>
        ...
        <AlertDialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
          ...
          >
            ...
            <span>
              {isResetting ? "Resetting Everything..." : "Reset All Data"}
            </span>
          </AlertDialogTrigger>
          ...
          <AlertDialogContent className="rounded-2xl border-destructive/20 sm:max-w-md">
            <AlertDialogHeader>
              ...
              <AlertDialogDescription className="text-sm leading-relaxed text-muted-foreground mx-auto text-center">
                This will permanently wipe all comic records, metadata, reading
                histories, and clean up physical storage on disk.{" "}
